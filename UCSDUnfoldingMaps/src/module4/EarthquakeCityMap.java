...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(255, 0, 0));
		triangle(50, 100 - 5, 50 + 10, 100 + 10, 50 - 10, 100 + 10);
		fill(color(255, 255, 255));
		ellipse(50, 125, 20, 20);
		fill(color(255, 255, 255));
		rect(50 - 10, 150 - 10, 20, 20);
	...
	private void printQuakes() 
	{
		...
		for (Marker cm : countryMarkers)
		{ 
			String countryInCountryMarker = cm.getStringProperty("name");
			...
			{ 
				...
				if (em.isOnLand())
				{
					 if (qm instanceof LandQuakeMarker)
					 {
						 ...
						 if (country.equals(countryInCountryMarker))
						 {
							 landQuakeCounter++;
						 }
					 }
			...
			if (landQuakeCounter > 0)
			{
				...
				System.out.println("Country: " + countryInCountryMarker + " - no. of earthquake " + landQuakeCounter);
			}
		}
		System.out.println("oceanQuakeCounter: " + oceanQuakeCounter);
